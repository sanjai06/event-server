...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    likedevent: Attribute.String & Attribute.DefaultTo<'[]'>;
    likedmovie: Attribute.String & Attribute.DefaultTo<'[]'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface PluginGenerateSchemaSchema extends Schema.CollectionType {
  collectionName: 'generate-schema_schema';
  info: {
    tableName: 'schema';
    singularName: 'schema';
    pluralName: 'schemas';
