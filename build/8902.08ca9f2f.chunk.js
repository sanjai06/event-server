(self.webpackChunkevent_server=self.webpackChunkevent_server||[]).push([[8902],{29520:Z=>{function U(d,o,g,O){for(var f=-1,E=d==null?0:d.length;++f<E;){var C=d[f];o(O,C,g(C),d)}return O}Z.exports=U},98694:(Z,U,d)=>{var o=d(1107);function g(O,f,E,C){return o(O,function(B,A,L){f(C,B,E(B),L)}),C}Z.exports=g},37177:(Z,U,d)=>{var o=d(29520),g=d(98694),O=d(90040),f=d(26126);function E(C,B){return function(A,L){var Q=f(A)?o:g,ee=B?B():{};return Q(A,C,O(L,2),ee)}}Z.exports=E},39738:(Z,U,d)=>{var o=d(93367),g=1/0;function O(f){var E=f==null?0:f.length;return E?o(f,g):[]}Z.exports=O},63799:(Z,U,d)=>{var o=d(71041),g=d(37177),O=Object.prototype,f=O.hasOwnProperty,E=g(function(C,B,A){f.call(C,A)?C[A].push(B):o(C,A,[B])});Z.exports=E},68902:(Z,U,d)=>{"use strict";d.d(U,{P:()=>vt,a:()=>Dt,u:()=>Tt});var o=d(74081),g=d(27279),O=d(48102),f=d(10701),E=d(32370),C=d(93415),B=d(61181),A=d(5938),L=d(6918),Q=d(15244),ee=d(35250),H=d(73411),D=d(22572),R=d(23298),k=d(74577),G=d(45322),w=d(24920),le=d(34642),de=d(69878),se=d(94098),X=d(61908),W=d(12146),J=d(10131),N=d(10124),r=d(70627),K=d(61020),Re=d(76873),be=d(8243),_=d(72450),ce=d(35318),je=d(10411),ve=d(57853),Ge=d(78582),v=d(98934),Oe=d(74919),Te=d(89486),Ee=d(82298),he=d(61815),ue=d(63799),fe=d(51943),Es=d(39738),ne=d(3243),Ms=d(87830),Y=d(43433),De=d(8175),Xe=d(40464);const[Ps,As]=(0,Re.k)("PermissionsDataManager"),pe=()=>As("usePermissionsDataManager"),Rs=_.default.div`
  position: relative;
...
`,Is=(e,s,n)=>e.map(({actionId:t,isDisplayed:i,applyToProperties:a,label:l})=>{if(!i)return{actionId:t,hasSomeActionsSelected:!1,isDisplayed:i};const c=[...n.split(".."),t],p=N(a)?[...c,"properties","enabled"]:c,u=p.join(".."),m=v(s,[...c,"conditions"],null),x=oe(m).some(y=>y);if(N(a)){const y=v(s,p,!1);return{actionId:t,checkboxName:u,hasAllActionsSelected:y,hasConditions:x,hasSomeActionsSelected:y,isDisplayed:i,isParentCheckbox:!1,label:l,pathToConditionsObject:c}}const b=v(s,p,null),{hasAllActionsSelected:$,hasSomeActionsSelected:M}=ie(b);return{actionId:t,checkboxName:u,hasAllActionsSelected:$,hasConditions:x,hasSomeActionsSelected:M,isDisplayed:i,isParentCheckbox:!0,label:l,pathToConditionsObject:c}}),We=(e,s)=>`
  ${Je} {
...
`,ns=({availableActions:e,isActive:s,isGrey:n,isFormDisabled:t,label:i,onClickToggle:a,pathToData:l})=>{const[c,p]=(0,g.useState)(!1),{formatMessage:u}=(0,K.Z)(),{modifiedData:m,onChangeParentCheckbox:x,onChangeSimpleCheckbox:b}=pe(),$=()=>{p(I=>!I)},M=()=>{p(!1)},y=v(m,l.split(".."),{}),h=(0,g.useMemo)(()=>Object.keys(y).reduce((I,F)=>(I[F]=Oe(y[F],"conditions"),I),{}),[y]),{hasAllActionsSelected:P,hasSomeActionsSelected:j}=ie(h),T=(0,g.useMemo)(()=>Is(e,m,l),[e,m,l]),V=T.some(({hasConditions:I})=>I);return(0,o.jsxs)(Bs,{isActive:s,children:[(0,o.jsxs)(Je,{isGrey:n,children:[(0,o.jsx)(Qe,{isCollapsable:!0,isFormDisabled:t,label:i,checkboxName:l,onChange:x,onClick:a,someChecked:j,value:P,isActive:s,children:(0,o.jsx)(ss,{paddingLeft:2,children:s?(0,o.jsx)(ve.Z,{}):(0,o.jsx)(Ge.Z,{})})}),(0,o.jsx)(f.k,{style:{flex:1},children:T.map(({actionId:I,hasConditions:F,hasAllActionsSelected:S,hasSomeActionsSelected:z,isDisplayed:me,isParentCheckbox:q,checkboxName:te,label:_e})=>me?q?(0,o.jsxs)(es,{justifyContent:"center",alignItems:"center",children:[F&&(0,o.jsx)(ts,{}),(0,o.jsx)(H.C,{disabled:t,name:te,"aria-label":u({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${_e} ${i}`}),onValueChange:re=>{x({target:{name:te,value:re}})},indeterminate:z,value:S})]},I):(0,o.jsxs)(es,{justifyContent:"center",alignItems:"center",children:[F&&(0,o.jsx)(ts,{}),(0,o.jsx)(H.C,{disabled:t,indeterminate:F,name:te,onValueChange:re=>{b({target:{name:te,value:re}})},value:S})]},I):(0,o.jsx)(Ie,{},I))}),c&&(0,o.jsx)(Se,{headerBreadCrumbs:[i,"Settings.permissions.conditions.conditions"],actions:T,isFormDisabled:t,onClosed:M,onToggle:$})]}),(0,o.jsx)(ks,{children:(0,o.jsx)(Me,{onClick:$,hasConditions:V})})]})};ns.propTypes={availableActions:r.array.isRequired,isActive:r.bool.isRequired,isGrey:r.bool.isRequired,isFormDisabled:r.bool.isRequired,label:r.string.isRequired,onClickToggle:r.func.isRequired,pathToData:r.string.isRequired};const Ws=_.default.span`
...
`,D=({title:R,description:k,as:G="span",togglePosition:w="right",action:le,...de})=>{const{onToggle:se,toggle:X,expanded:W,id:J,size:N,variant:r,disabled:K}=(0,E.A)(),Re=`accordion-content-${J}`,be=`accordion-label-${J}`,_=`accordion-desc-${J}`,ce=N==="M"?6:4,je=N==="M"?ce:ce-2,ve=C({expanded:W,disabled:K,variant:r}),v={as:G,fontWeight:N==="S"?"bold":void 0,id:be,textColor:W?"primary600":"neutral700",ellipsis:!0,variant:N==="M"?"delta":void 0},Oe=W?"primary600":"neutral600",Te=W?"primary200":"neutral200",Ee=N==="M"?`${32/16}rem`:`${24/16}rem`,he=()=>{K||(X&&!se?(console.warn('Deprecation warning: Usage of "toggle" prop in Accordion component is deprecated. This is discouraged and will be removed in the next major release. Please use "onToggle" instead'),X()):se&&se())},ue=(0,o.jsx)(L.k,{justifyContent:"center",borderRadius:"50%",height:Ee,width:Ee,transform:W?"rotate(180deg)":void 0,"data-strapi-dropdown":!0,"aria-hidden":!0,as:"span",background:Te,cursor:K?"not-allowed":"pointer",onClick:he,shrink:0,children:(0,o.jsx)(A.J,{as:g.Z,width:N==="M"?`${11/16}rem`:`${8/16}rem`,color:W?"primary600":"neutral600"})});return(0,o.jsx)(H,{paddingBottom:je,paddingLeft:ce,paddingRight:ce,paddingTop:je,background:ve,expanded:W,size:N,justifyContent:"space-between",cursor:K?"not-allowed":"",children:(0,o.jsxs)(L.k,{gap:3,flex:1,maxWidth:"100%",children:[w==="left"&&ue,(0,o.jsx)(ee,{onClick:he,"aria-disabled":K,"aria-expanded":W,"aria-controls":Re,"aria-labelledby":be,"data-strapi-accordion-toggle":!0,expanded:W,type:"button",flex:1,minWidth:0,...de,children:(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(f.y,{...v,children:R}),k&&(0,o.jsx)(Q.Z,{as:"p",id:_,textColor:Oe,children:k})]})}),w==="right"&&(0,o.jsxs)(L.k,{gap:3,children:[ue,le]}),w==="left"&&le]})})}},61181:(Z,U,d)=>{"use strict";d.d(U,{Q:()=>f});var o=d(74081),g=d(72450),O=d(97232);const f=({options:C,...B})=>(0,o.jsx)(O.NU,{...B,children:C.map(A=>"children"in A?(0,o.jsx)(O.Ab,{label:A.label,values:A.children.map(L=>L.value.toString()),children:A.children.map(L=>(0,o.jsx)(E,{value:L.value,children:L.label},L.value))},A.label):(0,o.jsx)(O.ML,{value:A.value,children:A.label},A.value))}),E=(0,g.default)(O.ML)`
